...
router.post("/upload/koperasi", upload.single("gambar_koperasi"), uploadKoperasi);
router.post("/upload/investasi", upload.single("gambar_investasi"), uploadInvestasi);
router.post("/upload/bumdes", upload.single("gambar_bumdes"), uploadBumdes);
...
router.post("/upload/popup", upload.single("gambar_popup"), uploadPopup);
...
router.post("/upload/wisata", upload.single("gambar_wisata"), uploadWisata);
